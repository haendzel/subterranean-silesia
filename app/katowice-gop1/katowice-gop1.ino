...
int stateCounterLEDBytom2 = LOW;
unsigned long blinkCounterLEDBytom2 = 500;
unsigned long worktimeCounterLEDBytom2 = 0;

//unsigned long workCoalMine1 = 300;
unsigned long workCoalMine2 = 120;
//unsigned long workCoalMine3 = 300;
unsigned long workCoalMine4 = 200;
unsigned long workCoalMine5 = 300;
unsigned long workCoalMine6 = 900;
unsigned long workCoalMine7 = 300;
unsigned long workCoalMine8 = 85;
...
void setup()
{
  ...
  pinMode(greenKatowice, OUTPUT);
  pinMode(greenGOP1, OUTPUT);
}
...
void loop()
{
  ...
  if (digitalRead(switchKatowice) == LOW)
  {
    ...
    digitalWrite(greenKatowice, HIGH);
  ...
  else
  {
    ...
    digitalWrite(greenKatowice, LOW);
  ...
  {
    blinkCounterLEDBytom2 = 400;
    digitalWrite(greenGOP1, HIGH);
...
void blinks()
{
  ...
  if (currentMillis - worktimeCounterLEDBytom2 >= blinkCounterLEDBytom2)
  {
    worktimeCounterLEDBytom2 = currentMillis;
    stateCounterLEDBytom2 = !stateCounterLEDBytom2;
    digitalWrite(CounterLEDBytom2, stateCounterLEDBytom2);
  }
}
