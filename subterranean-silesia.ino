...
#define CounterLEDBytom1 37
#define CounterLED 29
  #define coalMine2 52
...
unsigned long blinkCounterLEDKatowice1 = 500;
unsigned long worktimeCounterLEDKatowice1 = 0;

int stateCounterLEDBytom1 = LOW;
unsigned long blinkCounterLEDBytom1 = 100;
...
void loop(){
  ...
  if (currentMillis - worktimeCounterLEDBytom1 >= blinkCounterLEDBytom1) {
      ...
      digitalWrite(CounterLED, stateCounterLEDBytom1);
  }
}